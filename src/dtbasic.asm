...
#DEFINE cpmWriteString(str)     LD      DE, str
#DEFCONT \                      LD      C, 09H
#DEFCONT \                      CALL    0005H
...
MONITR: LD     C,00H    ; CP/M write string to console call
        CALL   0005H
